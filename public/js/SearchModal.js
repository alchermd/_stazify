...
Vue.component('search-modal', __webpack_require__(49));
...
/* scopeId */
var __vue_scopeId__ = "data-v-c3383204"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/SearchModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c3383204", Component.options)
  } else {
    hotAPI.reload("data-v-c3383204", Component.options)
  }
...
var update = __webpack_require__(52)("88168b04", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c3383204\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SearchModal.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c3383204\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./SearchModal.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios__["get"]('/api/industries').then(function (res) {
            return _this.industries = res.data;
        });
        __WEBPACK_IMPORTED_MODULE_0_axios__["get"]('/api/courses').then(function (res) {
    ...
    methods: {
        submitForm: function submitForm(event) {
            ...
            if (this.selected === 'Jobs') {
                ...
                url += "?title=" + encodeURI(this.job.title) + ("&company_name=" + encodeURI(this.job.company.name));
            ...
            if (this.selected === 'Companies') {
                ...
                url += "?company_name=" + encodeURI(this.company.name) + ("&email=" + encodeURI(this.company.email));
            ...
            if (this.selected === 'Students') {
                ...
                url += "?student_name=" + encodeURI(this.student.name) + ("&email=" + encodeURI(this.student.email));
        ...
        addSkillsRow: function addSkillsRow(event) {
            event.preventDefault();
            ...
            _c("div", { staticClass: "modal-body" }, [
                ...
                _c(
                  ...
                  [
                    _c("option", { attrs: { disabled: "" } }, [
                      _vm._v("I want to search for...")
                    ]),
                    _vm._v(" "),
                    _c("option", [_vm._v("Jobs")]),
                    _vm._v(" "),
                    _c("option", [_vm._v("Companies")]),
                    _vm._v(" "),
                    _c("option", [_vm._v("Students")])
                  ]
                )
              ]),
              _vm._v(" "),
              ...
              _vm.selected === "Jobs"
                ? _c("div", [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.job.company.name,
                            expression: "job.company.name"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: { type: "text", placeholder: "Company Name" },
                        domProps: { value: _vm.job.company.name },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _c("hr"),
                    _vm._v(" "),
                    _c("p", { staticClass: "form-text text-left" }, [
                      _vm._v(
                        "\n                            Skills\n                            "
                      ),
                      _c(
                    ...
                    _c(
                      "div",
                      { staticClass: "row" },
                      _vm._l(_vm.job.skills, function(skill) {
                        return _c(
                          "div",
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.company.industry,
                              expression: "company.industry"
                            }
                          ],
                          staticClass: "custom-select",
                          on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c3383204", module.exports)
  }
}
