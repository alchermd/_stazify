...
@section ('content')
    <div class="container mb-3 mt-3" style="font-family: monospace;">
        <h2>Terms of Use</h2>
        <p>
            Your privacy is important to us. It is Stazify's policy to respect your privacy regarding any information we
            may
            collect from you across our website, <a href="https://stazify.com">https://stazify.com</a>, and other sites
            we own
            and operate.
        </p>
        ...
        <p>
            ...
            and
            lawful means, with your knowledge and consent. We also let you know why we’re collecting it and how it will
            be
            used.
        </p>
